...
get_header(); // Load header.php logic in our file ?>
  ...
  <div class="funny-lemon-container">
    <div class="funny-lemon-image">
      <img src="<?php echo esc_url(get_template_directory_uri(). '/assets/img/canette_peche.png');?>" alt="Funny Peche">
    </div>
    <div class="funny-lemon-content">
      <h2>Funny Pêche</h2>
      <p>
        Funny Pêche est une boisson appréciée dans le monde entier par
...
<section class="section">
        <h2>Funny Pêche éveil vos sens</h2>
        <div class="cards">
            <div class="card">
